...
\begin{itemize}
	...
	\item 	\textbf{Scenario principale:} un utente non ancora autenticato richiede il login inserendo nell'apposito form\textsubscript{G} i dati necessari;
...
\item \textbf{Scenario principale}: l'utente non ancora autenticato, inserisce il suo codice identificativo nell'apposito form\textsubscript{G};
...
\item \textbf{Precondizioni}: l'utente vuole autenticarsi;
\item \textbf{Postcondizioni}: l'utente si è autenticato con successo come amministratore o responsabile;
\item \textbf{Scenario principale}: l'utente non ancora autenticato, inserisce la sua password nell'apposito input dentro form\textsubscript{G};
\item \textbf{Descrizione}: l'utente vuole autenticarsi, inserendo il suo codice identificativo.
\end{itemize}
