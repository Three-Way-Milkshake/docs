...
\begin{itemize}
	...
	Si riferisce all'unità stessa e a chi la guida. Ha il compito di soddisfare le task che gli vengono assegnate raggiungendo i POI necessari tramite la guida manuale oppure servendosi del pilota automatico.}
...
\begin{itemize}
	...
	\begin{itemize}
		\item UC4.1.2 - Inserimento priorità 0;
		\item UC4.1.3 - Inserimento priorità 1;
		\item UC4.1.4 - Inserimento priorità 2;
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Specializzazione:}
	\begin{itemize}
		\item UC4.5 - Aggiornamento priorità a 0;
		\item UC4.1.3 - Aggiornamento priorità a 1;
		\item UC4.1.4 - Aggiornamento priorità a 2;
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item 	\textbf{Scenario principale:} tramite una combobox, il responsabile seleziona la priorità 0.
	\item 	\textbf{Descrizione:} il responsabile si accorge che la priorità di una task\textsubscript{G} è errata o necessita di un aggiornamento, quindi procede con la modifica.
\end{itemize}
...
\begin{itemize}
	...
	\item 	\textbf{Scenario principale:} tramite una una combobox, il responsabile seleziona la priorità 2.
	\item 	\textbf{Descrizione:} il responsabile si accorge che la priorità di una task\textsubscript{G} è errata o necessita di un aggiornamento, quindi procede con la modifica.
\end{itemize}
...
\begin{itemize}
	...
	\item 	\textbf{Scenario principale:} il sistema controlla il movimento dell'unita e visualizza i cambi di direzione colorando la freccia interessata;
...
\subsection{UC13.1 - Visualizzazione liste di task non ancora prese in carico}
\begin{itemize}
	\item 	\textbf{Attori primari:} responsabile;
	\item 	\textbf{Precondizioni:} l'utente è autenticato come utente responsabile;
...
\subsection{UC13.2 - Visualizzazione liste di task assegnate}
\begin{itemize}
	\item 	\textbf{Attori primari:} responsabile;
	\item 	\textbf{Precondizioni:} l'utente è autenticato come utente responsabile;
