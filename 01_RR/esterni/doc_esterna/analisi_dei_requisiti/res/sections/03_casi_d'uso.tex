...
\paragraph{UC2.1.4 - Inserimento ruolo responsabile}
...
\paragraph{UC3.1.4 - Aggiornamento ruolo a responsabile}
...
\begin{itemize}
	...
	\item 	\textbf{Postcondizioni:} è stata assegnata alla nuova task la priorità 0;
	\item 	\textbf{Scenario principale:} il responsabile seleziona la priorità 0 attraverso la combobox;
	\item 	\textbf{Descrizione:} ogni task deve avere una priorità, il responsabile ha il compito di assegnarla. Una task con priorità 0 significa che non ha la precenza sulle altre.	
\end{itemize}
\paragraph{UC4.1.3 - Inserimento priorità 1}
\begin{itemize}
	\item 	\textbf{Attori primari:} responsabile;
	\item 	\textbf{Precondizioni:} il responsabile sta inserendo una nuova task\textsubscript{G} e deve scegliere che priorità assegnarle;
	\item 	\textbf{Postcondizioni:} è stata assegnata alla nuova task la priorità 1;
	\item 	\textbf{Scenario principale:} il responsabile seleziona la priorità 1 attraverso la combobox;
	\item 	\textbf{Descrizione:} ogni task deve avere una priorità, il responsabile ha il compito di assegnarla. Una task con priorità 1 significa che è un compito di media importanza.
...
\begin{itemize}
	\item 	\textbf{Attori primari:} responsabile;
	\item 	\textbf{Precondizioni:} il responsabile sta inserendo una nuova task\textsubscript{G} e deve scegliere che priorità assegnarle;
	\item 	\textbf{Postcondizioni:} è stata assegnata alla nuova task la priorità 2;
	\item 	\textbf{Scenario principale:} il responsabile seleziona la priorità 2 attraverso la combobox;
	\item 	\textbf{Descrizione:} ogni task deve avere una priorità, il responsabile ha il compito di assegnarla. Una task con priorità 2 significa che ha la precenza sulle altre.
	
\end{itemize}
\paragraph{UC4.1.5 - Inserimento relativo POI di scarico}
\begin{itemize}
	\item 	\textbf{Attori primari:} responsabile;
	\item 	\textbf{Precondizioni:} il responsabile sta inserendo una nuova task\textsubscript{G};
...
\begin{itemize}
	\item 	\textbf{Attori primari:} responsabile;
	\item 	\textbf{Precondizioni:} il responsabile sta visualizzando la lista di task(UC13) e ha selezionato la task della quale intende aggiornare la priorità;
