...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{res/images/uc3.png}
...
\begin{itemize}
	...
	\item 	\textbf{Postcondizioni:} l'utente ha effettuato le azioni (o di modifica/eliminazione di uno o più utenti o di visualizzazione della lista di utenti inseriti) che intendeva fare;
	\item 	\textbf{Scenario principale:} vengono visualizzate le operazioni che possono essere effettuate per gestire gli account già presenti:
	\begin{itemize}
	...
	\end{itemize}
	\item 	\textbf{Descrizione:} Ogni account può gestire (e quindi modificare) i propri dati personali mentre solo l'amministratore ha il compito di gestire tutti gli account presenti, visualizzandone la lista e aggiornandoli o eliminandoli.
\end{itemize}
...
\begin{itemize}
	\item 	\textbf{Attori primari:} amministratore, responsabile;
	\item 	\textbf{Precondizioni:} il sistema ha reso disponibile il campo del form\textsubscript{G} per modificare il nome dell'utente;
...
\begin{itemize}
	\item 	\textbf{Attori primari:} amministratore, responsabile;
	\item 	\textbf{Precondizioni:} il sistema ha reso disponibile il campo del form\textsubscript{G} per modificare il cognome dell'utente;
	...
	\item 	\textbf{Descrizione:} per effettuare la modifica del campo relativo al cognome, l'utente aggiorna il valore nel form\textsubscript{G}.
...
\begin{itemize}
	\item 	\textbf{Attori primari:} amministratore, responsabile;
	\item 	\textbf{Precondizioni:} il sistema ha reso disponibile il campo del form\textsubscript{G} per modificare la password dell'utente;
	\item 	\textbf{Postcondizioni:} l'utente ha compilato il campo con la password aggiornata;
	\item 	\textbf{Scenario principale:} l'utente compila il campo del form\textsubscript{G} relativo alla password da aggiornare;
	\item 	\textbf{Descrizione:} per effettuare la modifica del campo relativo alla password, l'utente aggiorna il valore nel form\textsubscript{G}.
...
\begin{itemize}
	\item 	\textbf{Attori primari:} amministratore;
	\item 	\textbf{Precondizioni:} il sistema ha reso disponibile la visualizzazione della lista dei responsabili, nella quale l'amministratore può resettare la password;
	\item 	\textbf{Postcondizioni:} il sistema riporta un messaggio di conferma del reset della password del responsabile specificato;
