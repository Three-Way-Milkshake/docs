...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item cognome.
	\end{itemize}
Il server poi ritornerà un codice identificativo e una password standard, con i quali il responsabile potrà fare il primo login, dove poi potrà modificare la password (UC3.1.3) per averne una tutta sua.
\end{itemize}
