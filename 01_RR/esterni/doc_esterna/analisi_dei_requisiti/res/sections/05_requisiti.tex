...
\begin{longtable}{ 
	...
	\endhead
RF-1-O &
Un utente deve effettuare il login alla piattaforma tramite il suo codice identificativo e la sua password
& UC1
\tabularnewline
RF-2-O &
...
\tabularnewline
RF-4.2-O &
L'amministratore può eliminare un utente precedentemente registrato
&UC3.2
\tabularnewline
RF-4.3-O&
...
\tabularnewline
RF-7.2-O&
Il server centrale permette la visualizzazione del senso di marcia delle zone di percorrenza all’amministratore e ai responsabili
&UC6
\tabularnewline
RF-7.2.1-O&
...
\tabularnewline
RF-10-O&
Il server centrale permette all'amministratore la visualizzazione di una notifica in caso di una segnalazione da parte di un operatore di un evento eccezionale
&
UC6.2
\tabularnewline
RF-11
...
O
&
La User Interface implementa sotto la mappa una lista ordinata delle task rimanenti da eseguire da parte dell’operatore che sta usando l’unità
&
UC8.2
\tabularnewline
RF-15
...
O
&
La User Interface che rappresenterà ogni singola unità dovrà prevedere le 3 frecce rotazionali
&
UC10
\tabularnewline
RF-17.1
...
O
&
Il server centrale permette all’operatore di visualizzare la direzione e lo spostamento del suo muletto, nel caso in cui sia attiva la guida automatica
&
UC10
\tabularnewline
RF-18
...
O
&
Ogni POI può essere di carico, di scarico o di base
&
Decisione interna
\tabularnewline
RF-46
