...
RF-8.1-O		&	Quando il responsabile inserisce una nuova task\textsubscript{G} dovrà specificare la sua priorità 	&	UC4.1.1\tabularnewline
RF-8.2-O		&	Quando il responsabile inserisce una nuova task\textsubscript{G} dovrà specificare il POI\textsubscript{A} a cui fa riferimento	&	UC4.1.5\tabularnewline
RF-8.3-O		&	Quando il responsabile conferma l'inserimento di una nuova task\textsubscript{G} e il sistema la assegna ad un'unità che la dovrà soddisfare	&	UC4.2\tabularnewline
RF-9-O		&	Il responsabile può eliminare una task\textsubscript{G} 	&	UC4.3\tabularnewline
RF-10-O		&	Il responsabile può modificare la priorità di una task\textsubscript{G} 	&	UC4.4\tabularnewline				
...
RF-19.1-O		&	L'amministratore può modificare planimetria\textsubscript{G} del magazzino	&	UC7.1\tabularnewline
RF-19.2-O		&	L'amministratore può modificare la percorrenza\textsubscript{G} del magazzino	&	UC7.2\tabularnewline
RF-20-O		&	L'amministratore può gestire i POI\textsubscript{A}	&	UC7.3\tabularnewline
RF-20.1-O		&	L'amministratore può modificare la posizione di un POI\textsubscript{A} già esistente	&	UC7.3.1\tabularnewline
RF-20.2-O		&	L'amministratore può inserire un nuovo POI\textsubscript{A}	&	UC7.3.2\tabularnewline
RF-20.2.1-O	&	Inserendo un nuovo POI\textsubscript{A}, l'amministratore dovrà specificare la sua posizione nella mappa	&	UC7.3.2.1\tabularnewline
RF-20.2.2-O	&	Inserendo un nuovo POI\textsubscript{A}, l'amministratore dovrà specificare il suo codice identificativo	&	UC7.3.2.2\tabularnewline
RF-20.2.3-O	&	Inserendo un nuovo POI\textsubscript{A}, l'amministratore dovrà specificare il tipo di POI\textsubscript{A} inserito (carico, scarico, base)	&	UC7.3.2.3\tabularnewline
RF-20.3-O		&	L'amministratore può eliminare un POI\textsubscript{A}	&	UC7.3.3\tabularnewline
...
RF-23-O		&	La mappa mostra il prossimo task\textsubscript{G} da soddisfare (POI da raggiungere) 	&	UC8.1\tabularnewline
RF-23.1-O		&	Nella mappa specifica dell'unità verrà evidenziato con un colore diverso il prossimo POI\textsubscript{A} da raggiungere	&	UC8.1\tabularnewline
