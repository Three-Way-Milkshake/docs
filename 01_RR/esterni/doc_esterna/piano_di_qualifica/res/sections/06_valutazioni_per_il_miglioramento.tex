...
Una difficoltà rilevante in queste valutazioni è il fatto che sono gestite dal gruppo stesso, quindi si tratta di un'autovalutazione. Ogni singolo membro deve esternare i propri problemi individuali e quelli di gruppo per permettere una celere risoluzione e favorire un lavoro più efficiente\textsubscript{G}.
...
\begin{longtable}{
	...
	\endfirsthead
	\endhead
	La versione gratuita è povera di funzioni importanti, ad esempio creazione di milestone\textsubscript{G}. &  Sfruttare al massimo le funzionalità offerte dalla versione gratuita.\\
