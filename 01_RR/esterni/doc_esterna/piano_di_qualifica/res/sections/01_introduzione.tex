...
\subsection{Scopo del documento}
    ...
    \begin{itemize}
        ...
        \item documentare le strategie di verifica e validazione che il gruppo Three Way Milkshake ha deciso di adottare relativi al progetto\textsubscript{G} PORTACS, per raggiungere gli obiettivi di qualità e soddisfare il cliente.
    \end{itemize}
