...
\pparagraph{Comandi clients → server}
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{|c|p{8cm}|c|}
            \hline
            \rowcolorhead
            \multicolumn{3}{|c|}{\headertitle{USER generico}}\\
            \hline
            \rowcolorhead
            \headertitle{Comando} & \headertitle{Descrizione} & \headertitle{Risposta} \\
            \hline
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{|c|p{8cm}|c|}
            \hline
            \rowcolorhead
            \multicolumn{3}{|c|}{\headertitle{MANAGER}}\\
            \hline
            \rowcolorhead
            \headertitle{Comando} & \headertitle{Descrizione} & \headertitle{Risposta} \\
            \hline
    ...
    %\begin{table}[h!]
        ...
        \begin{longtable}[h!]{|c|p{8cm}|c|}
            ...
            \hline
            \rowcolorhead
            \multicolumn{3}{|c|}{\headertitle{ADMIN}}\\
            \hline
            \rowcolorhead
            \headertitle{Comando} & \headertitle{Descrizione} & \headertitle{Risposta} \\
            \hline
...
\pparagraph{Comandi server → clients}
    \begin{table}[h!]
        ...
        \begin{tabular}{|c|p{8cm}|c|}
            \hline
            \rowcolorhead
            \multicolumn{3}{|c|}{\headertitle{GENERICI}}\\
            \hline
            \rowcolorhead
            \headertitle{Comando} & \headertitle{Descrizione} & \headertitle{Risposta} \\
            \hline
            ...
            \hline
        \end{tabular}
        \caption{Comandi clients → server | generici per tutti i client}
    \end{table}
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{|c|p{8cm}|c|}
            ...
            \hline
        \end{tabular}
        \caption{Comandi clients → server | Forklifts (muletti)}
    \end{table}
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{|c|p{8cm}|c|}
            ...
            \hline
        \end{tabular}
        \caption{Comandi clients → server | Utente Manager (responsabile)}
    \end{table}
