...
A fronte del \gls{modellosviluppo}\textsubscript{G} scelto e delle scadenze fissate, lo sviluppo procederà attraverso le seguenti \glspl{fase}\textsubscript{G}:
\begin{itemize}
	\item \textbf{Avvio}
...
Le \glspl{revisione}\textsubscript{G} di avanzamento scandiscono i \glspl{periodo}\textsubscript{G} entro i quali si articolano le \glspl{fase}\textsubscript{G} sopra descritte.
