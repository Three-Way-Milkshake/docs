...
\subsection{Gestione dei processi}
    \subsubsection{Scopo}
    Qui lo scopo è la gestione delle \gls{attivita}\textsubscript{G} e dei compiti per ogni altro processo.
    ...
    \end{itemize}
        ...
        \end{itemize}
        Come spiegato nella sezione \hyperref[jiraintegration]{Integrazione con Jira}, è stato configurato un processo automatico di collegamento fra \gls{gitcommit}\textsubscript{G} su GitHub e \gls{task}\textsubscript{G} in Jira. Inoltre ad ogni azione, manuale o automatica, su Jira, viene generata una notifica nel canale dedicato di Slack.
...
\subsection{I ruoli di progetto}
    ...
    Hai il compito specifico di comprendere il problema. Ha un ruolo attivo fin quando la comprensione non è adeguata. Adottando un modello \gls{incrementale}\textsubscript{G}, rimane più a lungo ed evolve. E auspicabile che ci siano più analisti per portare punti di vista diversi e sommare le conoscenze. Redige \textsc{Studio di Fattibilità} ed \textsc{Analisi dei Requisiti}.
    ...
    Agisce su ogni \gls{attivita}\textsubscript{G} ed attua una verifica oggettiva, segnalando eventuali problemi secondo il \hyperref[label]{text}{processo rispettivo}.
    ...
    Gestisce il controllo sul \gls{progetto}\textsubscript{G} e tramite un \gls{cruscotto}\textsubscript{G} di controllo aggiorna, revisiona ed adatta lo svolgimento dei lavori. Elabora piani e scadenze, assegna compiti, approva documenti, gestisce i problemi, redige l'\textsc{Organigramma} ed il \textsc{Piano di Progetto} ed approva l'offerta prima di sottoporla al committente.
    ...
    \subsubsection{Comunicazioni interne}
        ...
        \pparagraph{Slack}
            ...
            \begin{itemize}
                ...
                \begin{itemize}
                    \item jira, invierà una notifica ogni qualvolta che si intraprenderà un'azione, manuale o automatica (\textit{smart commits}) sul \gls{cruscotto}\textsubscript{G} di \gls{progetto}\textsubscript{G};
            ...
            \end{itemize}
        \pparagraph{Telegram}
            Software di messaggistica \footnote{\url{https://telegram.org/}} nel quale il gruppo \group ha un gruppo dedicato utilizzato solamente per le comunicazioni informali e non strettamente legate al \gls{progetto}\textsubscript{G} di lavoro.
