    ...
    \end{itemize}
        ...
        \begin{enumerate}
        	...
        	\begin{itemize}
        		...
        		\item Ogni qualvolta si esegue un commit con 'git commit\textsubscript{G} -m “PCS-\#\#\# \#comment <commento> \#time <tempo>” ' (quindi usando tracciamento temporale di Jira) e si incrementa nel foglio di calcolo.
        	\end{itemize}
