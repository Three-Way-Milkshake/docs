...
\subsection{Documentazione}
    ...
    \begin{itemize}
        ...
        \end{itemize}
    \end{itemize}
    Queste strutture possono essere richiamate rispettivamente tramite i comandi \textit{\textbackslash changelogTable\{...\}} e \textit{\textbackslash approvingTable\{...\}} definite nel template \LaTeX per i documenti formali.
...
\subsection{Gestione della configurazione}
    ...
    \subsubsection{Workflow di versionamento}
        ...
        \pparagraph{Pull requests}
            Per l'implementazione delle feature dai branch di lavoro, bisogna aprire una pull-request su develop. A questo punto il responsabile o l'amministratore provvederanno a fare i controlli necessari ed effettueranno il merge\footnote{Il merge in git\textsubscript{G}: \url{https://www.atlassian.com/git/tutorials/using-branches/git-merge}} tramite \textit{squash}.
