...
\subsection{Accertamento della qualità} %todo from PdQ
    AGGIUNGERE DA PIANO DI QUALIFICA
    \subsubsection{Scopo}
...
\subsection{Verifica} %todo from PdQ
    \label{verifica}
    AGGIUNGERE DA PIANO DI QUALIFICA
    \subsubsection{Scopo}
    Lo scopo del processo di ...
...
\subsection{Validazione} %todo from PdQ
    AGGIUNGERE DA PIANO DI QUALIFICA
    \subsubsection{Scopo}
    Lo scopo del processo di ...
    \subsubsection{Aspettative}
