...
\subsection{Gestione della configurazione}
    ...
    \subsubsection{Workflow}
        ...
        \pparagraph{Pull requests}
            Per l'implementazione delle feature dai branch di lavoro, bisogna aprire una pull request su develop. A questo punto il responsabile o l'amministratore provvederanno a fare i controlli necessari ed effettueranno il merge\footnote{Il merge in git: \url{https://www.atlassian.com/git/tutorials/using-branches/git-merge}} via \textit{squash}.

    \subsubsection{Strumenti}
        Come già detto, le repo sono tenute su GitHub, per quanto riguarda la gestione locale, ogni membro è libero di adottare lo strumento che preferisce.
