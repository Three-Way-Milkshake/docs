...
\subsection{Processi di Sviluppo}
	...
	\subsubsection{Analisi dei Requisiti}
		...
		\item []
			...
			\begin{itemize}
				\item \textbf{misurazione:} percentuale; $\frac{\text{requisiti\_obbligatori\_soddisfatti}}{requisiti\_obbligatori\_totali}$; %todo lasciare math text (corsivo) o forzare text normale
