...
Per garantire la qualità del prodotto, Three Way Milkshake adotta il \gls{vmodel}\textsubscript{G} per verificare tramite test ogni passo della produzione software.\\Qui vedremo un immagine rappresentativa del \gls{vmodel}\textsubscript{G} (o V-Model), quest'ultimo si può schematizzare posizionando il tempo nell'asse delle ascisse e il livello di astrazione nell'asse delle ordinate.\\Il modello idealmente si divide in 2 rami.\\Il ramo sinistro contiene le fasi di progettazione e ideazione; il ramo destro contiene le fasi di test e integrazione.
\begin{figure}[h!]
	\centering
...
\begin{itemize}
	...
	\item \textbf{Importanza:} indica l'importanza del requisito che può essere:
		\begin{itemize}
