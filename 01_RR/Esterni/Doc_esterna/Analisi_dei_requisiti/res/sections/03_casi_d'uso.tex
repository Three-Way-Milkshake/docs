...
\begin{itemize}
	...
	Si riferisce ad un utente autenticato che ha il compito di creare nuovi account di operatori, di modificare la planimetria o la sua percorrenza in caso di cambiamenti del magazzino e la gestione delle unità.}
\end{itemize}
...
\subsubsection{UC4.3 - Inserimento relativo POI di scarico}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item modificare la percorrenza del magazzino, per esempio i sensi di marcia (UC7.3);
...
\begin{itemize}
	...
	\item 	\textbf{Postcondizioni:}la mappa è stata modificata dall’amministratore;
	\item 	\textbf{Scenario principale:} viene visualizzata la mappa con le caratteristiche che ogni area di perocrrenza ha (senso di marcia e numero massimo di unità). L’amministratore deve premere sopra la zona che intende cambiare per aprire un pop-up e inserire gli aggiornamenti. Una volta raggiunto il risultato desiderato, l’amministratore conferma tramite il pulsante di salvataggio;
	\item 	\textbf{Descrizione:} il magazzino con il passare del tempo, può apportare dei cambiamenti nella percorrenza, sarà possibile modificare per ogni area:
	\begin{itemize}
		\item i sensi unici;
