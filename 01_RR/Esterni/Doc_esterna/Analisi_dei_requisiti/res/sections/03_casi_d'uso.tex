...
\begin{itemize}
	...
	\item 	\textbf{Postcondizioni:} il sistema ha ricevuto il compimento della task che verrà cancellata dalla lista completa di tutte le \gls{task}\textsubscript{G} da soddisfare e da quella personale dell’operatore;
