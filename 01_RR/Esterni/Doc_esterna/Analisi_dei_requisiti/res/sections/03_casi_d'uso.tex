...
\begin{itemize}
	\item 	\textbf{Attori primari:} amministratore;
	\item 	\textbf{Precondizioni:} è stato segnalato un evento eccezionale dall'operatore;
	\item 	\textbf{Postcondizioni:} viene visualizzata una notifica che avverte l'avvenimento un evento eccezionale;
	...
	\item 	\textbf{Descrizione:} l'operatore mentre sta completando le proprie task, può segnalare l'avvenimento di un evento eccezionale all'interno del magazzino (UC11.3). Il sistema dovrà notificare l'amministratore di questo e indicargli la posizione in cui è stato riscontrato.
\end{itemize}
