...
Durante questo periodo, vengono svolte le seguenti attività:
\begin{itemize}
	\item \textbf{Norme di progetto}: vengono stabilite le norme di progetto pianificando nel dettaglio i processi primari, i processi di sviluppo e i processi organizzativi. Viene redatto il documento \textsc{Norme di Progetto} dall'Amministratore;
	...
	\item \textbf{Piano di Qualifica}: in questa attività si individuano i criteri che garantiscono la qualità del prodotto. Il \textsc{Piano di Qualifica} è redatto, nella sua prima versione, dall'Amministratore;
	\item \textbf{Glossario}: il \textsc{Glossario} conterrà i termini a cui si riterrà necessario dare definizione. \`E redatto da tutti i membri del team;
...
\textit{Dal 2021-01-18 al 2021-02-28}
\\\\
...
\begin{itemize}
	...
	\item \textbf{Lettera di presentazione}: avviene la stesura della lettera con cui il gruppo si candida alla Revisione di Progettazione.
\end{itemize}
...
\begin{itemize}
	\item \textbf{Allegato Tecnico}: viene integrato l'\textsc{Allegato Tecnico}, che presenterà ora anche la Product Baseline, nella quale il software è scomposto e analizzato nelle sue unità. Redatto dai Programmatori;
...
\subsubsection{Progettazione di dettaglio e codifica dei requisiti desiderabili}
...
\begin{itemize}
	...
	\item \textbf{Lettera di presentazione}: avviene la stesura della lettera con cui il gruppo si candida alla Revisione di Qualifica.
...
\begin{itemize}
	...
	\item \textbf{Manuale Utente}: Nil documento Manuale Utente, la cui stesura è affidata ai Progettisti e agli Analisti, specifica le modalità d'uso del software agli utenti utilizzatori;
	...
	\item \textbf{Lettera di presentazione}: avviene la stesura della lettera con cui il gruppo si candida alla Revisione di Accettazione.
\end{itemize}
