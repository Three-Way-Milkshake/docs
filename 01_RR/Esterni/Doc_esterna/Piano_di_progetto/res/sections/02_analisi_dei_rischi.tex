...
\begin{longtable} { 
	...
	&
	\textbf{Rilevamento}: \\ La comunicazione risulta così complessa da causare incomprensioni importanti o rallentare in modo considerevole il lavoro. I membri sono interessati da problemi personali legati all'emergenza sanitaria che impattano sullo svolgimento dei propri compiti.
	& 
...
\begin{longtable} { 
	...
	\caption{RIS\_I - 2 } \endhead	
	
	
	\textbf{Nome}: \\ Impegni esterni 
	& \textbf{Codice}: \\ RIS\_I - 2 
	& \textbf{Occorrenza}: Alta \\ \textbf{Pericolosità}: Media
	
	\tabularnewline
	
	\textbf{Descrizione}: \\ La disponibilità dei membri del gruppo nella partecipazione al lavoro risente degli impegni esterni a cui essi sono soggetti. Questi impegni
