...
\begin{longtable} { 
	...
	& 
	\textbf{Rilevamento}: \\ Il gruppo non riesce a definire con precisione quali \glspl{requisito}\textsubscript{G} siano richiesti dal prodotto e ha difficoltà a definire con precisione il comportamento degli attori coinvolti.
...
\begin{longtable} { 
	...
	&  
	\gls{cruscotto}\textsubscript{G} di progetto. Significativi discostamenti tra preventivo e costi effettivamente sostenuti verranno comunicati con tempestività al proponente.
