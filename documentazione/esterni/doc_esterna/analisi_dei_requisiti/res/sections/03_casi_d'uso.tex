...
\begin{itemize}
	...
	\item 	\textbf{Postcondizioni:} l'amminsitratore ha cambiato il profilo di un utente;
	\item 	\textbf{Scenario principale:} l'amministratore visualizza la lista di utenti e seleziona quello che intende modificare. Il sistema visualizza i dettagli dell'account (nome, cognome)  modificati. Infine conferma le operazioni;
	\item 	\textbf{Descrizione:} l'amministratore vuole modificare i dati di un account.
...
\begin{itemize}
	\item 	\textbf{Attori primari:} utente autenticato;
	\item 	\textbf{Precondizioni:} l'utente autenticato ha premuto il pulsante per la modifica dell'account;
